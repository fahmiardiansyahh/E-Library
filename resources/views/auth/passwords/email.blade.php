...
@section('TextInformation', 'Reset Your Password Bellow To Get New Password Confirmation From Your Email!')
          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small><img src="{{ asset('assets/img/brand/librarynobg.png') }}" alt="header-login" class="h-50 w-50 img-fluid"></small>
                  @if(session('status') ) 
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                       <strong>Check Your Email</strong> Link Has Been Send!
              ...
              <form role="form" action="{{ route('password.email') }}" method="POST">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4">Reset Your Password</button>
                </div>
              </form>
            </div>
          </div>
